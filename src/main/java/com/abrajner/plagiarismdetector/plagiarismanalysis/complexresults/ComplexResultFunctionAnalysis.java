...
@Component
public class ComplexResultFunctionAnalysis implements AnalysisApplicationService {
    
    private final ComplexResultAnalysis complexResultAnalysis;
    
    public ComplexResultFunctionAnalysis(final ComplexResultAnalysis complexResultAnalysis) {
