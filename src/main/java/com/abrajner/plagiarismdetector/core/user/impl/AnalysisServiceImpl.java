...
import com.abrajner.plagiarismdetector.core.user.analysisAlgorithms.LineByLineAnalysis;
...
public class AnalysisServiceImpl implements AnalysisService {
    ...
    final LineByLineAnalysis analysisLineByLineApplicationService;
    ...
    public AnalysisServiceImpl(final ReportRepository reportRepository,
        ...
        this.analysisLineByLineApplicationService = analysisLineByLineApplicationService;
    }
    ...
    public void performAnalysis(final Long groupId, final String reportName) {
        ...
        reportEntities.forEach(reportEntity -> {
            ...
            final ReportEntity reportWithCalculatedResults = this.analysisLineByLineApplicationService.performAnalysis(
